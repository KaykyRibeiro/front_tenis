...
export default function BtnSidebar({ icon, label, expanded, acctive, rootNavigation }: BtnSidebarProps) {
    ...
    return (
        ...
        className={clsx("cursor-pointer overflow-hidden flex rounded-xl  text-black dark:text-white transition-all duration-300 ease-in-out", 
        expanded ? "w-43" : "w-14 items-center justify-center", 
        acctive ? " text-white bg-primary-color" : "hover:bg-gray-300 dark:hover:bg-gray-700")}>
