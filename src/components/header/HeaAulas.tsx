...
interface HeaAulasProps {
  onOpenNovaAula: () => void;
}

export default function HeaAulas({ onOpenNovaAula }: HeaAulasProps) {
  return (
    <div className="w-full flex md:flex-row flex-col justify-between px-6 lg:px-10 py-4 gap-4 md:items-center bg-white/60 dark:bg-black-smooth backdrop-blur-xl border-b border-gray-200/50 dark:border-zinc-800/50">
      ...
      <div className="flex flex-row items-center gap-3">
        <button
          onClick={onOpenNovaAula}
          className="flex items-center gap-2 bg-primary-color text-white px-5 py-2.5 rounded-xl hover:bg-green-600 transition-all active:scale-95 shadow-lg shadow-primary-color/20 font-medium text-sm"
        >
