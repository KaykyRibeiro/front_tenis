...
export default function Login() {
  ...
  return (
    ...
    <div className="bg-[url(/public/banner-bg/bg-img-tenis.jpg)] bg-cover bg-center h-screen w-screen flex justify-center items-center">
      <div className="bg-black/20 backdrop-blur-sm p-10 rounded-2xl shadow-xl border border-white/10">
        <div className="flex justify-center items-center">
          <img src="/public/logo/logo-p-preto.png" alt="" className="w-100" />
        </div>
        <form action=""
          //onSubmit={}
          ...
          <div className="mt-10">
            <input type="text"
              ...
              className="w-150 border-b border-white p-3 text-white placeholder:text-white/70 font-light text-lg focus:outline-none" />
          </div>
          ...
          <p
            className="cursor-pointer w-full items-end text-end text-gray-smooth/80 font-light text-sm hover:text-gray-smooth mb-20"
